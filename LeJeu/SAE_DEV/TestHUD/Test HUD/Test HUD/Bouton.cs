...
namespace Test_HUD
{
    internal class Bouton
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(Game1._font, $"{NomBouton}", EstSurvole() ? new Vector2(PositionBouton.X - Game1._font.MeasureString(NomBouton).X / 2, PositionBouton.Y - Game1._font.MeasureString(NomBouton).Y / 2 + 5) :  new Vector2(PositionBouton.X - Game1._font.MeasureString(NomBouton).X/2, PositionBouton.Y - Game1._font.MeasureString(NomBouton).Y / 2 - 10), Color.Black);
