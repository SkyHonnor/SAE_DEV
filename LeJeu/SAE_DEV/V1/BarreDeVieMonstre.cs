...
namespace TheGame
{
    internal class BarreDeVieMonstre
    {
        ...
        public BarreDeVieMonstre(Monstre monstre, Color couleurBarreDeVie, Rectangle grandeurBarreDevie, GraphicsDevice graphicsDevice)
        {
        ...
        public void Update()
        {
            ...
            this.contenance.Width = Largeur * Monstre.Pv / PvMax;
        }
    }
}
